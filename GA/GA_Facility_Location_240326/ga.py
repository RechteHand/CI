...
def main() -> None:
    Problem.read_instance("GA_Facility_Location/ga750a-1.txt")

    best = Individual(Problem.n)
    best.initialize()
    best.fitness()
    ...
    for _ in range(GA.pop_size):
        individual = Individual(Problem.n)
    ...
    for iteration in range(1, GA.number_of_iterations + 1):
        ...
        for _ in range(0, GA.pop_size, 2):
            ...
            son = Individual(Problem.n)
            daughter = Individual(Problem.n)
